...
public class TextureRegionParallaxLayer extends ParallaxLayer {
  ...
  /**
   * Creates a TextureRegionParallaxLayer with regionWidth and regionHeight
   * equal that of the texRegion. Paddings are set to 0.
   *
  ...
  /**
   * Creates a TextureRegionParallaxLayer with regionWidth and regionHeight
   * equal to parameters width and height. Paddings are set to 0.
   *
   * @param texRegion the texture region
  ...
  /**
   * Creates a TextureRegionParallaxLayer with either regionWidth or
   * regionHeight equal oneDimen specified, while the other is calculated
   * maintaining the aspect ratio of the region. Paddings are set to 0.
   *
